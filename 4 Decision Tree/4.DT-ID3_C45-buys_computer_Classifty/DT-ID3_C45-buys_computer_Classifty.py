...
def calcInformationGain(dataSet,baseEntropy,i):
    ...
    #得到增益  # 信息增益，就yes熵的减少，也就yes不确定性的减少
...
def createTree(dataSet, labels, featLabels):
    ...
    #如果类别完全相同则停止继续划分# 第一个递归结束条件：所有的类标签完全相同
    ...
    #bestFeat = chooseBestFeatureToSplitByID3(dataSet)	#选择最优特征
